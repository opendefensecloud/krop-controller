...
- Repo skeleton (`api/ cmd/ internal/ config/ test/`); pin deps (kro `v0.9.2`, kcp sdk `v0.32`,
  multicluster-provider `v0.8`, ctrl-runtime `v0.24`, cel-go `v0.27`, k8s `v0.36`); adapt the copied
